...
![累计收益曲线](cumulative-performance.png?v=6222a60a95d0)
...
- 本次构建里的最新事件/快照：**2026-07-03T08:08:53.375Z**
...
- `api-v1-order.csv`：**43,243** 行
- `api-v1-execution-tradeHistory.csv`：**173,373** 行
- `api-v1-user-walletHistory.csv`：**17,424** 行
- 时间范围：**2020-05-01 → 2026-07-03**
...
- 最新调整后钱包等值财富（XBT+USDt 范围）：**97.81111490 XBT**（相对基准 **53.171524x**）
- 最新调整后按保证金计价财富（XBT+USDt 范围）：**100.44120814 XBT**（相对基准 **54.601280x**）
